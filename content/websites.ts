...
export const deliverables: LabelledRow[] = [
  {
    label: "The site",
    body: "Five pages, written from your answers. Your services, your area, your prices, and why people pick you over the guy down the road. It reads like you because every line came from something you said.",
  },
  {
    label: "Built for phones",
    body: "Click-to-call buttons, a contact form that goes straight to your inbox, and a layout built thumb-first. Most people who find you are standing in a driveway holding a phone.",
  },
  {
    label: "Your real proof",
    body: "Your Google reviews, your service area, your actual prices. The things a stranger checks before letting you near a $40,000 truck.",
  },
  {
    label: "Photos",
    body: "Yours are best. Your crew, your trucks, your finished jobs. Four of yours beat forty of somebody else's. If you haven't got them, you tell me in the questionnaire whether you'd rather go AI-generated, stock, or a mix, and I come back with options instead of guessing.",
  },
  {
    label: "A brand guide",
    body: "Your colours pulled out of your logo and built into a full system, with a type pairing and a short guide to your voice. You keep the document. It's what stops your next flyer, truck wrap, and invoice looking like three different companies.",
  },
  {
    label: "An SEO plan",
    body: "The site gets built for local search from the start: your location and services where Google looks for them, fast pages, clean structure. You also get a checklist of what moves the needle from here, ordered the way I'd do it.",
  },
  {
    label: "Found locally",
    body: "Your Google Business Profile set up and linked to the site.",
  },
  {
    label: "AI employees",
    body: "Ready-made AI roles built around your business. Copywriter, website designer, email marketer, finance consultant. More on these below.",
  },
  {
    label: "Your command centre",
    body: "One Notion document that ties the whole thing together: how to work every part of your site, how to use each AI employee, and what extended help looks like if you want it. Written for somebody who has never touched any of this before.",
  },
  {
    label: "Training",
    body: "Videos covering everything you'd realistically want to change, plus a session with the platform's own onboarding team that I book for you.",
  },
  {
    label: "The keys",
...
export const processSteps: ProcessStep[] = [
  {
    ...
    body: "This is an interview, so set aside half an hour and do it somewhere you can think. It asks about your services, your area, your prices or ranges, how you like to work, and why people choose you. One section asks how you actually talk about the job, and that's the part that stops the finished site sounding like every other site in your trade. Be thorough. Everything you write becomes the website, and the more you give me the less back-and-forth there is later.",
  },
  {
  ...
  },
  {
    ...
    detail: [
      "Brand extraction. The colours in your existing logo become a full colour system rather than a guess",
  ...
  },
  {
    ...
    system: "DNS cutover",
    body: "Once you're happy, you settle the balance. Your site goes live the same day, usually within a couple of hours, on your own web address in an account that belongs to you. Your existing email keeps working. That's part of the job.",
  },
  {
  ...
  },
  {
    ...
    system: "Enablement",
    body: "Handing over a login isn't the same as showing somebody how to use it. You get the platform's own first-run walkthrough, my videos covering everything you'd realistically want to change, and a session with the platform's onboarding team that I book for you. Your command centre document holds all of it in one place, including the AI employees and videos of them being used on real work.",
  },
];
...
export const aiEmployees = {
  intro:
    "If someone handed you a million dollars tomorrow, you'd hire people. Some of them would be another set of hands on the tools. The rest would be sitting at a desk, writing and quoting and chasing and marketing. Those are the ones you can have now.",
  how: "Each one is a written brief. You paste it into an AI chat and it turns up already knowing your business: your services, your prices, your area, and how you talk about the work. It was built from the same answers your website was built from, so it doesn't sound like a stranger guessing at your trade.",
  roles: [
    {
      role: "Copywriter",
  ...
  note: "Those are four examples. What comes with your build depends on your trade. Your command centre document walks through each one, with videos of them used on real day-to-day work and a short crash course on the more capable setups if you decide to go further.",
} as const;
...
export const addOns: PricedRow[] = [
  {
    label: "Online booking setup · your services, hours, one shared calendar synced",
    price: "$250",
  },
  {
    label:
 ...
 * catalogue and nothing in this repo states what it includes. Publishing a
 * recurring charge with no stated scope is a trust leak, and inventing the
 * scope is a service claim I will not make on his behalf. So it stays off the
 * page rather than going up vague.
 *
 * His current thinking, 2026-08-21, recorded so it is not re-derived: on call
 * for questions, with a monthly ceiling, possibly around two hours. That is a
 * direction and not yet an offer - a published ceiling is a commitment, and it
 * is the number clients will hold him to. When he settles it, add:
 *
...
export const changeTiers: Array<PricedRow & { note: string }> = [
  ...
  },
  {
    label: "My mistakes",
    price: "Free",
    note: "If I typo'd your phone number or broke a link, I fix it free, 14 days from delivery",
  },
];
...
export const upFront: LabelledRow[] = [
  ...
  },
  {
    ...
    body: "I can't promise you'll rank #1 on Google. Nobody honest can. What I can promise is a site built properly for local search, fast and mobile-ready, with your location and services where Google looks for them. Plus a checklist of what to do from here, ordered the way I'd do it. It'll be a hell of a lot better than what you've got now.",
  },
  {
...
export const faq: Array<{ q: string; a: string }> = [
  ...
  },
  {
    ...
    a: "Yes, and you should. It's a self-serve platform. Hours, photos, prices, text, new enquiries and invoices all live in a dashboard you log into, with no code and no cost. Nobody has you handcuffed to a technical person, which is what most people are really asking here. Paid rounds are only for when you want me doing structural work: new sections, a new page, a rewrite.",
  },
  {
  ...
  },
  {
    ...
    a: "No. You answer the questionnaire in your own words and I write the site from it. One section asks how you actually talk about the job, so what comes out sounds like you instead of like a template. You'll read it before it goes live and tell me what's wrong.",
  },
  {
    q: "What if I don't have good photos?",
    a: "Most people don't, and it isn't a problem. Yours are best where they exist. Where they don't, you tell me in the questionnaire whether you'd rather go AI-generated, stock, or a mix, and I come back with a couple of options to pick from. Guessing is what turns this into three rounds of revisions.",
  },
  {
    q: "What if I already have a domain?",
    a: "We use it. If it's pointed at an old site, I'll do the cutover, including making sure your existing email keeps working. That's the part that usually gets broken.",
  },
  {
    q: "If the platform is self-serve, why do I need you?",
    a: "You don't, strictly. You could sit down with the same tools and get something out of them. What you're paying for is knowing which questions to ask, and what to do with the answers. Turning a real business into a brief an AI can build something authentic from is the actual skill, and it's the difference between your site and the generic thing the same tools produce when nobody has done that work. You also get a week of my time instead of a month of yours, and a set of AI employees you keep using long after the site is finished.",
  },
  {
...
export const closing = {
  line: "Ready? Start the questionnaire. Give it half an hour somewhere quiet, and you can stop and come back whenever you like.",
