...
/**
 * The taste gallery for the **service** pack — businesses that sell services.
 *
 * ## Not curated yet
 *
 ...
 *
 * Most run light and read as open for business. Include the exceptions, and
 * include at least a few that lead with price rather than with photography.
 *
 ...
 */
export const SERVICE_EXAMPLES: ExampleSet = {
  curated: false,
  sites: [],
};
