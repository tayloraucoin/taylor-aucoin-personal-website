...
/**
 * The taste gallery for the **entity** pack — studios, teams, and anything that is an organisation rather than a person.
 *
 * ## Not curated yet
 *
 ...
 *
 * The subject is a group. Include sites that put a team on the page well, and
 * sites that deliberately do not, because both are legitimate and the client's
 * reaction to the difference is the signal.
 *
 ...
 */
export const ENTITY_EXAMPLES: ExampleSet = {
  curated: false,
  sites: [],
};
