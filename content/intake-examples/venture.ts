...
/**
 * The taste gallery for the **venture** pack — ventures and projects raising money or finding members.
 *
 * ## Not curated yet
 *
 ...
 *
 * Span both halves of this kind's job: **raising** sites (a fund, a property,
 * a co-op) and **joining** sites (a residency, a members' club, a community).
 * The first client on this pack is both at once, which is exactly why the set
 * cannot lean to one side.
 *
 ...
 */
export const VENTURE_EXAMPLES: ExampleSet = {
  curated: false,
  sites: [],
};
