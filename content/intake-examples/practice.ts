...
/**
 * The taste gallery for the **practice** pack — consultants, coaches, speakers, and authors.
 *
 * ## Not curated yet
 *
 ...
 *
 * These clients are selling judgement rather than artefacts, so include sites
 * that carry a person's authority with very little imagery — the failure mode
 * here is a gallery that only shows work-heavy layouts they cannot fill.
 *
 ...
 */
export const PRACTICE_EXAMPLES: ExampleSet = {
  curated: false,
  sites: [],
};
